...
Purpose: This method is copys the texture to the render and then presents it to screen.

Entry:  SDL_Texture *tempTexture: Texture that was orignally .png image. Its dimensions are set to be
rendered.
const int tim: const int represents time to present the textures to the screen. In this case it's half a second
...
public:
	...
	//Render method
	void Render(SDL_Texture *tempTexture, SDL_Renderer* tempRenderer,  const int tim);
};
#endif
