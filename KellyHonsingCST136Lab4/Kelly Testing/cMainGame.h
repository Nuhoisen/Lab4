...
...................................................................
void GameLoop(SDL_Texture * mainSurface[IMAGE_TOTAL], cSpriteGameLoop * tempSprite, cImageTextures* tempImage)

Purpose: Initates the rendering of either the regurlar images or the sprites.  It does this by calling their respective functions from its body.

Entry: SDL_Texture * mainSurface[IMAGE_TOTAL]:This is a series of textures that are passed via the cmd line args.
 cSpriteGameLoop * tempSprite: Contains a sprite object so that the sprite object can call its render function.
 cImageTextures* tempImage: Contains a image object so that the image object can call its render function.
...
public: 
	...
	void GameLoop(SDL_Texture * mainSurface[IMAGE_TOTAL], SDL_Renderer * mainRender);
